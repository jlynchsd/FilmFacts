...
class GetMovieActorsUtilTest {
    ...
    fun setup() {
        ...
        coEvery {
            filmFactsRepository.getMovies(movieOrder = any(), includeGenres = any(), minimumVotes = any())
        ...
        coEvery {
            ...
            0,
            listOf(
                MovieCreditEntry(0, "foo", null, 0, "foo"),
                MovieCreditEntry(0, "bar", null, 1, "bar"),
                MovieCreditEntry(0, "fizz", null, 2, "fizz"),
                MovieCreditEntry(0, "buzz", null, 3, "buzz"),
                MovieCreditEntry(0, "fin", null, 4, "fin")
            )
        )
        ...
        coEvery {
            ...
            ActorMovieCredits(0, "foo", "foo", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(1, "bar", "bar", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(2, "fizz", "fizz", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(3, "buzz", "buzz", emptyList(), 0, 0, "", "")
        )
    ...
    fun `When getting actors but seed movies are null returns empty result`() = runTest {
        ...
        val actors = getMovieActors(filmFactsRepository, recentPromptsRepository)
    ...
    fun `When getting actors and many credits returns actors`() = runTest {
        coEvery {
            ...
            listOf(
                ...
                MovieCreditEntry(0, "buzz", null, 3, "buzz"),
                MovieCreditEntry(0, "fin", null, 4, "fin"),
                MovieCreditEntry(0, "alpha", null, 5, "alpha"),
                MovieCreditEntry(0, "bravo", null, 6, "bravo"),
                MovieCreditEntry(0, "charlie", null, 7, "charlie")
            )
        )
    ...
    fun `When getting actor credits and popular actors are recent returns null`() = runTest {
        ...
        val credits = getActorMovieCredits(
    ...
    fun `When getting credits and character name has unclosed parentheses removes everything past parenthesis`() = runTest {
        coEvery {
            ...
            ActorMovieCredits(0, "foo(", "foo", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(1, "bar(some stuff", "bar", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(2, "fizz((", "fizz", emptyList(), 0, 0, "", ""),
            ActorMovieCredits(3, "buzz([{", "buzz", emptyList(), 0, 0, "", "")
        )
    ...
    private companion object {
        ...
        val creditCount = (1 .. 4)
        val creditFilter: (ActorMovieCredits) -> Boolean = { true }
    }
}